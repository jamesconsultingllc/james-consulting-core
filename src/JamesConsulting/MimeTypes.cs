...
/// <summary>
/// Provides strongly typed constants for common MIME types grouped by top-level media type.
/// </summary>
public static class MimeTypes
{
    /// <summary>
    /// MIME types under the <c>application</c> media type.
    /// </summary>
    public static class Application
    {
        ...
        /// <summary>"application/java-archive".</summary>
        ...
        /// <summary>"application/rss+xml".</summary>
        ...
        /// <summary>"application/x-font-otf".</summary>
        public const string XFontOtf = "application/x-font-otf";

        /// <summary>"application/x-font-ttf".</summary>
        public const string XFontTtf = "application/x-font-ttf";

        /// <summary>"application/x-font-woff".</summary>
        ...
        /// <summary>"application/x-pkcs12".</summary>
        ...
        /// <summary>"application/x-silverlight-app".</summary>
    ...
    /// <summary>
    /// MIME types under the <c>audio</c> media type.
    /// </summary>
    public static class Audio
    {
        /// <summary>"audio/midi".</summary>
        ...
        /// <summary>"audio/x-aac".</summary>
        public const string XAac = "audio/x-aac";

        /// <summary>"audio/x-aiff".</summary>
    ...
    /// <summary>
    /// MIME types under the <c>image</c> media type.
    /// </summary>
    ...
    /// <summary>
    /// MIME types under the <c>multipart</c> media type.
    /// </summary>
    ...
    /// <summary>
    /// MIME types under the <c>text</c> media type.
    /// </summary>
    public static class Text
    {
        ...
        /// <summary>"text/yaml".</summary>
        public const string Yaml = "text/yaml";
    }

    /// <summary>
    /// MIME types under the <c>video</c> media type.
    /// </summary>
