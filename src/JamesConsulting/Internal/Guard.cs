//  ----------------------------------------------------------------------------------------------------------------------
//  <copyright file="Guard.cs" company="James Consulting LLC">
//    Copyright (c) 2025 James Consulting LLC. Licensed under the MIT License.
//  </copyright>
//  <author>Rudy James</author>
//  <summary>
//    Internal argument-validation helpers replacing the Metalama.Patterns.Contracts attributes
//    (NotNull, NotEmpty, NotNullOrEmpty, Required, StrictlyPositive). Multi-targets net462,
//    netstandard2.0/2.1, net9.0, and net10.0 with polyfills for [NotNull] and
//    [CallerArgumentExpression] on older runtimes.
//  </summary>
//  ----------------------------------------------------------------------------------------------------------------------
using System;
...
namespace JamesConsulting.Internal
{
    ...
    internal static class Guard
    {
        ...
        /// <summary>Throws <see cref="ArgumentException"/> when <paramref name="value"/> has zero length. Caller is expected to pre-validate non-null.</summary>
        ...
        /// <summary>Throws <see cref="ArgumentException"/> when array <paramref name="value"/> has zero length. Caller is expected to pre-validate non-null.</summary>
